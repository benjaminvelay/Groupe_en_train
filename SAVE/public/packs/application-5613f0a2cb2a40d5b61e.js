...
/* WEBPACK VAR INJECTION */(function(global) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_bootstrap__ = __webpack_require__(/*! bootstrap */ 3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_bootstrap___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_bootstrap__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_is_loading__ = __webpack_require__(/*! is-loading */ 16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_is_loading___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_is_loading__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_flatpickr__ = __webpack_require__(/*! flatpickr */ 17);
...
var $elt = document.querySelector('input[type="submit"]');

// Start the script
__WEBPACK_IMPORTED_MODULE_1_is_loading___default()($elt).loading();

// Stop the script
__WEBPACK_IMPORTED_MODULE_1_is_loading___default()($elt).remove();

__WEBPACK_IMPORTED_MODULE_2_flatpickr___default()(".datepicker", {
  altInput: true,
  dateFormat: "d-m-Y H:i"
});

var resultListDeparture = document.getElementById("resultsDeparture");
var resultListArrival = document.getElementById("resultsArrival");
var liList = document.querySelectorAll(".autocomplete-proposition");

document.addEventListener('keyup', function (event) {

  resultListDeparture.innerHTML = "";

  var inputUser = document.getElementById("search_station_departure").value;
  fetch("API LINK " + inputUser).then(function (response) {
    return response.json();
  }).then(function (data) {
    data.forEach(function (gare) {
      var proposition = gare.category === "city" ? gare.label : null;
      if (proposition === null) {} else {
        var element = "<li class=\"autocomplete-proposition\"><i class=\"fas fa-subway\"></i> " + proposition + "</li>";
...
document.addEventListener('keyup', function (event) {
  ...
  var inputUser = document.getElementById("search_station_arrival").value;
  fetch("API LINK " + inputUser).then(function (response) {
    return response.json();
  }).then(function (data) {
    data.forEach(function (gare) {
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-5613f0a2cb2a40d5b61e.js.map